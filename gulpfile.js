...
var jekyllCommand = (/^win/.test(process.platform)) ? 'bundle' : 'bundle';
...
gulp.task('jekyll-build', function (done) {
	return spawn(jekyllCommand, ['exec', 'jekyll', 'build'], {stdio: 'inherit'}).on('close', done);
});
...
gulp.task('watch', function() {
	...
	gulp.watch('src/img/**/**/*.{webm}', ['webm']);
	gulp.watch(['*html', '_includes/**/*html', '_layouts/*.html'], ['jekyll-rebuild']);
});

gulp.task('default', ['js', 'sass', 'fonts', 'imagemin', 'browser-sync', 'watch', 'webm']);
